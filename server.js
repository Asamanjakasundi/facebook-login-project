...
passport.use(new Strategy(
    {
        clientID: '604288878449918',
        clientSecret: '2aa226b14fa886e9d7f4072cc074c762',
...
app.use(require('express-session')({secret: 'LCO app', resave: true, 
...
passport.authenticate('facebook')); //calling the strategy

//@route  - GET  /login/facebook/callback
//@desc  -  a route to facebook auth failed
//@access  -  PUBLIC
